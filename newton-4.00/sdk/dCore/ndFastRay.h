...
#ifndef ND_FAST_RAY_H_
#define ND_FAST_RAY_H_
...
class ndFastRay: public ndRay
{
	...
	D_CORE_API ndFloat32 PolygonIntersect(ndFloat32 maxT, const ndVector* const vertexBuffer, const ndInt32* const indexArray, ndInt32 indexCount) const;
	D_CORE_API ndFloat32 PolygonIntersect(const ndVector& normal, ndFloat32 maxT, const ndVector* const vertexBuffer, const ndInt32* const indexArray, ndInt32 indexCount) const;
