...
#ifndef __ND_JOINT_SLIDING_HINGE_H__
#define __ND_JOINT_SLIDING_HINGE_H__

#include "ndNewtonStdafx.h"
#include "ndJointBilateralConstraint.h"

D_MSV_NEWTON_CLASS_ALIGN_32
class ndJointSlidingHinge: public ndJointBilateralConstraint
{
	public:
	D_CLASS_REFLECTION(ndJointSlidingHinge, ndJointBilateralConstraint)

	D_NEWTON_API ndJointSlidingHinge();
	D_NEWTON_API ndJointSlidingHinge(const ndMatrix& pinAndPivotFrame, ndBodyKinematic* const child, ndBodyKinematic* const parent);
	D_NEWTON_API ndJointSlidingHinge(const ndMatrix& pinAndPivotInChild, const ndMatrix& pinAndPivotInParent, ndBodyKinematic* const child, ndBodyKinematic* const parent);
	D_NEWTON_API virtual ~ndJointSlidingHinge();
