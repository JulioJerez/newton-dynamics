...
ndJointSlidingHinge::ndJointSlidingHinge()
...
ndFloat32 ndJointSlidingHinge::GetOmega() const
{
	return m_rotationAxis.m_paramSpeed;
}

bool ndJointSlidingHinge::GetLimitStateAngle() const
{
	return m_rotationAxis.m_limitState;
}

void ndJointSlidingHinge::SetLimitStateAngle(bool state)
{
...
void ndJointSlidingHinge::SetLimitsAngle(ndFloat32 minLimit, ndFloat32 maxLimit)
{
#ifdef _DEBUG
	if (minLimit > 0.0f)
	{
...
void ndJointSlidingHinge::GetLimitsAngle(ndFloat32& minLimit, ndFloat32& maxLimit) const
{
	minLimit = m_rotationAxis.m_minLimit;
	maxLimit = m_rotationAxis.m_maxLimit;
}

ndFloat32 ndJointSlidingHinge::GetOffsetAngle() const
{
	return m_rotationAxis.m_targetParam;
}

void ndJointSlidingHinge::SetOffsetAngle(ndFloat32 angle)
{
	m_rotationAxis.m_targetParam = angle;
}

void ndJointSlidingHinge::SetAsSpringDamperAngle(ndFloat32 regularizer, ndFloat32 spring, ndFloat32 damper)
{
...
void ndJointSlidingHinge::GetSpringDamperAngle(ndFloat32& regularizer, ndFloat32& spring, ndFloat32& damper) const
{
...
ndFloat32 ndJointSlidingHinge::GetPosit() const
{
	return m_positionAxis.m_param;
}

ndFloat32 ndJointSlidingHinge::GetTargetPosit() const
{
	return m_positionAxis.m_targetParam;
}

void ndJointSlidingHinge::SetTargetPosit(ndFloat32 offset)
{
	m_positionAxis.m_targetParam = offset;
}

bool ndJointSlidingHinge::GetLimitStatePosit() const
{
	return m_positionAxis.m_limitState;
}

void ndJointSlidingHinge::SetLimitStatePosit(bool state)
{
...
void ndJointSlidingHinge::SetLimitsPosit(ndFloat32 minLimit, ndFloat32 maxLimit)
{
	ndAssert(minLimit <= 0.0f);
	ndAssert(maxLimit >= 0.0f);
#ifdef _DEBUG
...
void ndJointSlidingHinge::GetLimitsPosit(ndFloat32& minLimit, ndFloat32& maxLimit) const
{
	minLimit = m_positionAxis.m_minLimit;
	maxLimit = m_positionAxis.m_maxLimit;
}

void ndJointSlidingHinge::SetAsSpringDamperPosit(ndFloat32 regularizer, ndFloat32 spring, ndFloat32 damper)
{
...
void ndJointSlidingHinge::GetSpringDamperPosit(ndFloat32& regularizer, ndFloat32& spring, ndFloat32& damper) const
{
...
void ndJointSlidingHinge::DebugJoint(ndConstraintDebugCallback& debugCallback) const
{
	ndMatrix matrix0;
	ndMatrix matrix1;
...
void ndJointSlidingHinge::SubmitSpringDamperAngle(ndConstraintDescritor& desc, const ndMatrix& matrix0, const ndMatrix& )
{
...
void ndJointSlidingHinge::SubmitSpringDamperPosit(ndConstraintDescritor& desc, const ndMatrix& matrix0, const ndMatrix& matrix1)
{
	// add spring damper row
...
void ndJointSlidingHinge::ApplyBaseRows(ndConstraintDescritor& desc, const ndMatrix& matrix0, const ndMatrix& matrix1)
{
...
ndFloat32 ndJointSlidingHinge::PenetrationOmega(ndFloat32 penetration) const
{
...
void ndJointSlidingHinge::ClearMemory()
{
...
void ndJointSlidingHinge::UpdateParameters()
{
	ndMatrix matrix0;
	ndMatrix matrix1;
	CalculateGlobalMatrix(matrix0, matrix1);
...
void ndJointSlidingHinge::SubmitLimitsAngle(ndConstraintDescritor& desc, const ndMatrix& matrix0, const ndMatrix& matrix1)
{
	if (m_rotationAxis.m_limitState)
	{
...
ndFloat32 ndJointSlidingHinge::PenetrationSpeed(ndFloat32 penetration) const
{
...
void ndJointSlidingHinge::SubmitLimitsPosit(ndConstraintDescritor& desc, const ndMatrix& matrix0, const ndMatrix& matrix1)
{
	if (m_positionAxis.m_limitState)
	{
...
void ndJointSlidingHinge::JacobianDerivative(ndConstraintDescritor& desc)
{
	ndMatrix matrix0;
	ndMatrix matrix1;
	CalculateGlobalMatrix(matrix0, matrix1);
