...
#ifndef ND_SHAPE_HEIGHT_FIELD_
#define ND_SHAPE_HEIGHT_FIELD_
...
class ndShapeHeightfield: public ndShapeStaticMesh
{
	...
	D_COLLISION_API virtual ~ndShapeHeightfield() override;
	...
	D_COLLISION_API ndGridConstruction GetBuildMode() const;
