...
#ifndef ND_SHAPE_POINT_H_
#define ND_SHAPE_POINT_H_
...
class ndShapePoint: public ndShapeConvex
{
	...
	D_COLLISION_API virtual ~ndShapePoint() override;

	virtual ndShapePoint* GetAsShapePoint() override { return this; }
