...
#ifndef ND_MESH_EFFECT_H_
#define ND_MESH_EFFECT_H_
...
//	void GetEdgeAttributeIndex (const void* edge, dInt32& v0, dInt32& v1) const;
	...
	class ndVertexWeight
	{
		...
		void Clear()
		{
			...
			{
				m_boneId[i] = 0xffffffff;
				m_weight[i] = ndReal(0.0f);
			}
		}

		void SetWeight(ndUnsigned32 hash, ndReal weight)
		{
		...
		ndUnsigned32 m_boneId[ND_VERTEX_WEIGHT_SIZE];
	};
