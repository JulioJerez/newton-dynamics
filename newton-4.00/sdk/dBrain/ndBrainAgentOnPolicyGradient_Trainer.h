...
#ifndef ND_BRAIN_AGENT_ON_POLICY_TRAINER_H_
#define ND_BRAIN_AGENT_ON_POLICY_TRAINER_H_
...
class ndBrainAgentOnPolicyGradient_Trainer : public ndClassAlloc, public ndBrainContextUpdateCallback
{
	...
	ndSharedPtr<ndBrainFloatBuffer> m_minibatchAdvantageBuffer;
	ndSharedPtr<ndBrainFloatBuffer> m_minibatchInvLikelihoodBuffer;
	...
	ndSharedPtr<ndBrainFloatBuffer> m_minibatchCriticStateValueBuffer;
	ndSharedPtr<ndBrainFloatBuffer> m_minibatchBrocastAdvantageBuffer;
	ndSharedPtr<ndBrainFloatBuffer> m_minibatchClippedMinimunZeroGradient;
	ndSharedPtr<ndBrainFloatBuffer> m_minibatchClippedMaximumZeroGradient;
