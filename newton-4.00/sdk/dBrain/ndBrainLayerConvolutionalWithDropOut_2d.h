...
#ifndef ND_BRAIN_LAYER_CONVOLUTIONAL_WITHDROPOUT_2D_H_
#define ND_BRAIN_LAYER_CONVOLUTIONAL_WITHDROPOUT_2D_H_
...
class ndBrainLayerConvolutionalWithDropOut_2d : public ndBrainLayerConvolutional_2d
{
	...
	virtual ~ndBrainLayerConvolutionalWithDropOut_2d() override;
