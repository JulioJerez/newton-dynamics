...
#ifndef ND_BRAIN_LAYER_ACTIVATION_LINEAR_H_
#define ND_BRAIN_LAYER_ACTIVATION_LINEAR_H_
...
class ndBrainLayerActivationLinear : public ndBrainLayerActivation
{
	...
	void SetWeights(ndBrainTrainerInference* const trainer, const ndBrainVector& paremeters) override;
