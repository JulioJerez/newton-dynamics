...
bool ndRenderShaderCache::CreateAllEffects()
{
	...
	m_dynamicPointEffect = CreateShaderEffect(m_wireFrameVertexColor, m_wireFramePixel);
	m_dynamicLinesEffect = CreateShaderEffect(m_wireFrameVertexColor, m_wireFramePixel);
