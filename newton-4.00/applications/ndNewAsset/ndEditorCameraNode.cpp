...
bool ndEditorCameraNode::UpdatePickBody()
{
	ndAssert(0);
	...
	//					const ndFloat32 linearFrictionAccel = 40.0f * ndMax(ndAbs(EDITOR_GRAVITY), ndFloat32(10.0f));
...
void ndEditorCameraNode::ResetPickBody()
{
	if (*m_pickJoint)
	{
